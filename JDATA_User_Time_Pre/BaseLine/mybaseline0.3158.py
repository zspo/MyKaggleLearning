...
def make_user_order_table():
    ...
    train.to_csv('user_order_table.csv', index=False)
    print(train.head())

if __name__ == '__main__':
    make_user_order_table()

    new_order = pd.read_csv('user_order_table.csv', parse_dates=['o_date'])
    ...
    print(np.sum((new_order['mon_4_user_orders'][:50000] + new_order['mon_3_user_orders'][:50000] + new_order['mon_2_user_orders'][
                                                                                            :50000] + new_order[
                                                                                                          'mon_1_user_orders'][
                                                                                                      :50000]) == 0))
    # 用前15天随机出时间
