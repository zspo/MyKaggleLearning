...
def main():
    ...
    print('pro data time used {} s'.format(pro_end_time - pro_start_time))
    print('***************** Training Data *********************')
    ...
    print('trian data time used {} s'.format(train_end_time - train_start_time))
    # *********************************************************
    print('***************** Sub Data *********************')
...
if __name__ == "__main__":
    ...
    print("all time used {} s".format(end - start))
    print('****************** end ************************')