...
off_train = pd.read_csv('../dataset/ccf_offline_stage1_train.csv',header=0)
...
off_test = pd.read_csv('../dataset/ccf_offline_stage1_test_revised.csv',header=0)
off_test.columns = ['user_id','merchant_id','coupon_id','discount_rate','distance','date_received']
#11429826 record(872357 with coupon_id),762858 user(267448 in off_train)
on_train = pd.read_csv('../dataset/ccf_online_stage1_train.csv',header=0)
...
other_feature3.to_csv('../dataset/other_feature3.csv',index=None)
...
other_feature2.to_csv('../dataset/other_feature2.csv',index=None)
...
other_feature1.to_csv('../dataset/other_feature1.csv',index=None)
...
dataset3.to_csv('../dataset/coupon3_feature.csv',index=None)
#dataset2
...
dataset2.to_csv('../dataset/coupon2_feature.csv',index=None)
#dataset1
...
dataset1.to_csv('../dataset/coupon1_feature.csv',index=None)
...
merchant3_feature.to_csv('../dataset/merchant3_feature.csv',index=None)
...
merchant2_feature.to_csv('../dataset/merchant2_feature.csv',index=None)
...
merchant1_feature.to_csv('../dataset/merchant1_feature.csv',index=None)
...
user3_feature.to_csv('../dataset/user3_feature.csv',index=None)
...
user2_feature.to_csv('../dataset/user2_feature.csv',index=None)
...
user1_feature.to_csv('../dataset/user1_feature.csv',index=None)
...
user_merchant3.to_csv('../dataset/user_merchant3.csv',index=None)
...
user_merchant2.to_csv('../dataset/user_merchant2.csv',index=None)
...
user_merchant1.to_csv('../dataset/user_merchant1.csv',index=None)
...
coupon3 = pd.read_csv('../dataset/coupon3_feature.csv')
merchant3 = pd.read_csv('../dataset/merchant3_feature.csv')
user3 = pd.read_csv('../dataset/user3_feature.csv')
user_merchant3 = pd.read_csv('../dataset/user_merchant3.csv')
other_feature3 = pd.read_csv('../dataset/other_feature3.csv')
...
coupon2 = pd.read_csv('../dataset/coupon2_feature.csv')
merchant2 = pd.read_csv('../dataset/merchant2_feature.csv')
user2 = pd.read_csv('../dataset/user2_feature.csv')
user_merchant2 = pd.read_csv('../dataset/user_merchant2.csv')
other_feature2 = pd.read_csv('../dataset/other_feature2.csv')
...
coupon1 = pd.read_csv('../dataset/coupon1_feature.csv')
merchant1 = pd.read_csv('../dataset/merchant1_feature.csv')
user1 = pd.read_csv('../dataset/user1_feature.csv')
user_merchant1 = pd.read_csv('../dataset/user_merchant1.csv')
other_feature1 = pd.read_csv('../dataset/other_feature1.csv')
